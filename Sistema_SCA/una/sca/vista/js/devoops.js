...
function VerificaUsuario(tipoUsuario){
    alert("Funcion Verificar Usuario");
    
    if(tipoUsuario==="administrador"){
        $('#primerLink').hide();
    }
    location.href = "una/sca/vista/principal.php";
            ...
            reader.onload = (function (theFile) {
                return function (e) {
                    ...
                    document.getElementById(place).innerHTML =
                            ['<img style="width:150px;height:100" class="thumb"\n\
...
function DrawAllCharts() {
    //  Chart 1
    var chart1_data = [
        ['Equipo', 'Basketball Masculino', 'Futbol Masculino', 'Karate', 'béisbol Masculino', 'Ajedrez'],
        ['01.01.2014', 1234, 2342, 344, 232, 131],
        ['08.01.2014', 1254, 232, 314, 232, 331],
        ['15.01.2014', 2234, 342, 298, 232, 665],
        ['22.01.2014', 2234, 42, 559, 232, 321],
        ['29.01.2014', 1999, 82, 116, 232, 334],
        ['05.02.2014', 1634, 834, 884, 232, 191],
        ['12.01.2014', 321, 342, 383, 232, 556],
        ['19.01.2014', 845, 112, 499, 232, 731]
    ];
    var chart1_options = {
        title: 'Equipos',
    ...
    var chart2_data = [
        ['Height', 'Width'],
        ['Basketball Masculino', 74.5],
        ['Futbol Masculino', 31.24],
        ['Basketball Femenino', 12.10],
        ['Futbol Femenino', 11.14],
        ['béisbol Masculino', 8.3],
        ['Béisbol Femenino', 7.4],
        ['Natacion', 6.8],
        ['Ajedrez', 6.63],
        ['Porrismo', 3.5],
        ['Karate', 43.15]
    ...
    var chart2_options = {
        title: 'Porcentaje de Asistencia por Equipo',
        backgroundColor: '#fcfcfc'
    };
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        select: function (start, end, allDay) {
            var form = $('<form id="event_form">' +
                    ...
                    '<div>' +
                    '<input type="text" id="newevent_name" class="form-control" placeholder="Nombre del Evento">' +
                    '</div>' +
                    '<label>Descripción</label>' +
                    '<div>' +
                    '<textarea rows="3" id="newevent_desc" class="form-control" placeholder="Descripción"></textarea>' +
                    '</div>' +
                    '</div>' +
                    // aqui abajo  se modifica para que muestre los partcipantes y asignar las asistencias
                    //'</form>'
                    ...
                    + '<td>Greivin Vives</td>'
                    + '<td>Futbol</td>'
                    + '<td> <input type="checkbox" name="" value=""></i></td>'
                    + '<td> <input type="checkbox" name="" value=""></i></td>'
                    + '<td> <input type="checkbox" name="" value=""></i></td>'
            ...
            OpenModalBox('Agregar Evento', form, buttons);
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        select: function (start, end, allDay) {
            var form = $('<form id="event_form">' +
                    ...
                    + '<div class="col-sm-2">'
                    + '<input type="text" class="form-control" placeholder="Nombre" data-toggle="tooltip" data-placement="bottom" title="Nombre">'
                    + '</div>'
                    + '</div>'
                    ...
                    '<div>' +
                    '<input type="text" id="newevent_name" class="form-control" placeholder="Motivo de Consulta">' +
                    '</div>' +
                    '<label>Observaciones</label>' +
                    '<div>' +
                    '<textarea rows="3" id="newevent_desc" class="form-control" placeholder="Observaciones"></textarea>' +
                    '</div>' +
                    '</div>' +
                    // aqui abajo  se modifica para que muestre los partcipantes y asignar las asistencias
                    '</form>'
...
function DrawFullCalendar2() {
    LoadCalendarScript(DrawCalendar2);
}
//////////////////////////////////////////////////////
//////////////////////////////////////////////////////
//
